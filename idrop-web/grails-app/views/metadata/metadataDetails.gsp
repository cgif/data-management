...
<div id="metadataDetailsArea" class="container-fluid">
	...
	<div id="detailsToolbar" class="row well">
		<div id="detailsMenu" class="span12 btn-group">
			<button type="button" id="addMetadataButton" value="addMetadata" onclick="prepareMetadataDialog()")>
				<g:message code="default.button.create.label" />
			</button>
			<button type="button" id="deleteMetadataButton" value="deleteMetadata" onclick="deleteMetadata()")>
				<g:message code="default.button.delete.label" />
			</button>
			<button type="button" id="reloadAclButton" value="reloadMetadata" onclick="reloadMetadataDetailsTable()")>
